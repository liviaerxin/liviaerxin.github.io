---
sidebar_label: End-to-End ML Deployment with MLflow, Docker, and FastAPI
...
S3-compatible artifact store used by MLflow to save models.
...
Remember: all these following operations are in local host and separate with the docker container environment!
...
### Updating Models and Rolling Deployment
